...
export const es: Record<Translation, string> = {
    ...
    'auth.username.placeholder': 'Escriba su nombre de usuario',
    'auth.username.required': 'su nombre de usuario es requerido',
    ...
    'auth.password.label-confirm': 'Confirmar contraseña',
    'auth.password.placeholder': 'Escriba su contraseña de usuario',
    'auth.password.placeholder-confirm': 'Escriba su confirmación de contraseña de usuario',
    'auth.password.required': 'su contraseña de usuario es requerida',
    'auth.password.required-confirm': 'confirmación de contraseña es requerida',
    'auth.password.equal': 'contraseña y confirmación deben coincidir',
    ...
    'auth.sign-up.sign-up': 'Crear cuenta',
